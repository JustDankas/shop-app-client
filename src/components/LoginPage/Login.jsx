...
const {Group:FormGroup,Label:FormLabel,Control:FormControl,Text:FormText} = Form;
function Login() {
        ...
        <div className="auth">
                <div className="form-c">
                    <form className='form' onSubmit={(e)=>handleLoginSubmit(e)}>
                        ...
                        <span className="meta-span">New user? <Link to={'/auth/register'}>Create an account here!</Link></span>
                    </form>
                </div>
        </div>
     );
