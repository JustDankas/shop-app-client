...
function Reviews() {
  ...
  useEffect(() => {
    if (user) {
      axios
        .get(
          `${process.env.REACT_APP_API_URL}/products/reviews/user/${user.username}`
        )
        .then((res) => {
  ...
  return (
    <div className="reviews">
              ...
              <div className="review-user-c">
                ...
                <div className="review-user-info">
                  <Link
                    ...
                    className="review-product-title"
                  >
                    {innerWidth > 600
                      ? review.productId.title
                      : review.productId.title.slice(0, 40) + "..."}
                  </Link>
      ...
      {reveiws?.length === 0 && (
        <div className="missing-reviews-c">
