...
function MyAccount() {
    ...
    function handleNav(path){
        navigate(`${process.env.PORT}/account/my-account${path}`)
    }
            ...
            <div className="my-account-c">
                ...
                <nav className='profile-nav'>
                    <div className="nav-option">
                        ...
                        <button 
                        className={(location.pathname.split('/')[3]===undefined || location.pathname.split('/')[3]==='')?'nav-btn nav-active':'nav-btn'} 
                        onClick={()=>handleNav('')}>
                            My Account
                        </button>
                    </div>
                    <div className="nav-option">
                        ...
                        <button 
                        className={location.pathname.split('/')[3]==='favourites'?'nav-btn nav-active':'nav-btn'} 
                    ...
                    <div className="nav-option">
                        ...
                        <button 
                        className={location.pathname.split('/')[3]==='reviews'?'nav-btn nav-active':'nav-btn'} 
                    ...
                    <div className="nav-option">
                        ...
                        <button 
                        className={location.pathname.split('/')[3]==='settings'?'nav-btn nav-active':'nav-btn'} 
